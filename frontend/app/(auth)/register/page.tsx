      ...
      <div className="w-full max-w-sm animate-fade-up">
        ...
        <div className="bg-white rounded-2xl border border-sand-200 p-8 shadow-sm">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-sand-600 mb-1.5 uppercase tracking-wide">Full name</label>
              <input value={fullName} onChange={e => setFullName(e.target.value)} required placeholder="Ahmed Hassan" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="password" value={password} onChange={e => setPass(e.target.value)} required placeholder="min 8 chars" minLength={8} />
            </div>
